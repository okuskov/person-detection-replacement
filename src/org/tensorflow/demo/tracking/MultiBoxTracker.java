...
public class MultiBoxTracker {
  ...
  public List<RectF> mTrackedPosList = new ArrayList<>();
  ...
  public synchronized void draw(final Canvas canvas) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
     final RectF trackedPos =
      ...
      if (recognition.title.equals("cup") || recognition.title.equals("bowl") || recognition.title.equals("potted plant"))
        mTrackedPosList.add(trackedPos);
